...
public class ShowService {
    ...
    public ShowResponse createShow(ShowRequest request) {
        ...
        if (hasOverlap) {
            ...
            throw new AppException(ErrorCode.SHOW_EXISTED); // You might want to create a new error code
        }
    ...
    public ShowResponse updateShow(Long showId, UpdateShowRequest request) {
        ...
        boolean hasOverlap = showRepository.countOverlappingShow(
                ...
                startTime,
                endTime,
                showId // Exclude current show from overlap check
        )>0;
        ...
        return showMapper.toShowResponse(updatedShow);
    }

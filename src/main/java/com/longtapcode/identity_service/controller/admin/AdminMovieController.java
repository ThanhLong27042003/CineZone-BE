...
public class AdminMovieController {
    ...
    @PutMapping("/{movieId}")
    public ApiResponse<MovieResponse> updateMovie(@PathVariable Long movieId, @RequestBody UpdateMovieRequest request) {
        return ApiResponse.<MovieResponse>builder()
    ...
    public ApiResponse<Void> deleteMovie(@PathVariable Long movieId) {
        ...
        return ApiResponse.<Void>builder().message("Movie deleted successfully").build();
    }
}

...
public class AuthenticationController {
    ...
    public ApiResponse<AuthenticationResponse> logIn(
            HttpServletResponse res, @RequestBody @Valid AuthenticationRequest request) {
    ...
    public ApiResponse<?> logOut(HttpServletResponse res, @RequestBody @Valid AuthenticationRequest request) {
        ...
        return ApiResponse.<String>builder().result("User loged out!!").build();
    }

    @PostMapping("/refreshToken")
    public ApiResponse<RefreshTokenResponse> refreshToken(HttpServletRequest req) throws ParseException, JOSEException {
